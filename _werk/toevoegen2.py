        ...
        if vpl==[]:
            ...
            for j in range(lengte2):
                ...
                try:
                    ...
                    #db.query("insert into IncidentDetails(id, incidentNumber, briefDescription, reporterName, externalNumber, assetId, creationDate) values('a308f875-de21-461a-ac45-dd1c2c5818fc', 'I161027 020', 'FW: toegangsrechten op de J:\\' , 'D haene, Evi', '', 'Empty', '2016-10-27T11:37:14Z')")
                    fout+=1
