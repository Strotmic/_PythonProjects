...
for j in range(lengte2):
    ...
    if vpl != []:
        ...
        #in onderstaande for lus doorlopen we alle waardes die in deze dictionary zitten
        for p in range(lengte):
            ...
            #hier checken we of de verschillende rijen gelijke invulwaardes hebben en we stellen deze gelijk
            if p>0:
