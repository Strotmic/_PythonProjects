...
db = _mysql.connect(user='root', password='Gusco10.+789',
                              host='127.0.0.1',
                              database='odata')
#db.query("insert into IncidentDetails(id, incidentNumber, briefDescription, reporterName, externalNumber, assetId, creationDate) values('b308f875-de21-461a-ac45-dd1c2c5818fc', 'I161027 020', 'FW: toegangsrechten op de J://' , 'D haene, Evi', '', 'Empty', '2016-10-27T11:37:14Z')")
